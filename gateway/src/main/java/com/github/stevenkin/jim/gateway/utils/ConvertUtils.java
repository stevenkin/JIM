...
public abstract class ConvertUtils {
    ...
    public static final short objectToShort(Object o) {
        if (o instanceof Number) {
            ...
            try {
                return o == null ? -1 : Short.parseShort(o.toString());
            } catch (NumberFormatException var2) {
                return -1;
            }
        }
    ...
    public static final long objectToLong(Object o) {
        if (o instanceof Number) {
            ...
            try {
                return o == null ? -1L : Long.parseLong(o.toString());
            } catch (NumberFormatException var2) {
                return -1L;
            }
        }
    ...
    public static final String objectToString(Object obj, DecimalFormat fmt) {
        ...
        if (obj instanceof Double) {
            ...
            return obj instanceof Long ? fmt.format((Long)obj) : obj.toString();
        }
    }
    ...
    public static java.util.Date sqlTimestampToDate(Timestamp t) {
        return t != null ? new java.util.Date(Math.round((double)t.getTime() + (double)t.getNanos() / 1000000.0D)) : null;
    }
    ...
    public static double roundNumber(double rowNumber, int roundingPoint) {
        double base = Math.pow(10.0D, (double)roundingPoint);
    ...
    public static Object getObject(String type, String value) throws Exception {
        ...
        if ("boolean".equals(type)) {
            ...
            return Class.forName(type).getConstructor(String.class).newInstance(objs);
        }
    }
