...
@Component
public class BusinessServerProperties {
    ...
    public BusinessServerProperties(@Value("${business.host}")String host, @Value("${business.port}")int port, @Value("${business.path}")String path, @Value("${business.bossLoopGroupThreads}")int bossLoopGroupThreads, @Value("${business.workerLoopGroupThreads}")int workerLoopGroupThreads, @Value("${business.useCompressionHandler}")boolean useCompressionHandler, @Value("${business.connectTimeoutMillis}")int connectTimeoutMillis, @Value("${business.soBacklog}")int soBacklog, @Value("${business.writeSpinCount}")int writeSpinCount, @Value("${business.writeBufferHighWaterMark}")int writeBufferHighWaterMark, @Value("${business.writeBufferLowWaterMark}")int writeBufferLowWaterMark, @Value("${business.soRcvbuf}")int soRcvbuf, @Value("${business.soSndbuf}")int soSndbuf, @Value("${business.tcpNodelay}")boolean tcpNodelay, @Value("${business.soKeepalive}")boolean soKeepalive, @Value("${business.soLinger}")int soLinger, @Value("${business.allowHalfClosure}")boolean allowHalfClosure, @Value("${business.readerIdleTimeSeconds}")int readerIdleTimeSeconds, @Value("${business.writerIdleTimeSeconds}")int writerIdleTimeSeconds, @Value("${business.allIdleTimeSeconds}")int allIdleTimeSeconds, @Value("${business.maxFramePayloadLength}")int maxFramePayloadLength) {
